        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <div class="page-title-box d-flex justify-content-between align-items-center">
                    <button class="btn btn-primary btn-md" data-toggle="modal" data-target="#addMaterialLoanModal">
                        <i class="mdi mdi-plus"></i> Add Material Loan
                    </button>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="page-title">Material Loan Records</h5>
                            ...
                            <table id="datatable" class="table table-bordered table-striped dt-responsive nowrap" style="width:100%">
                                ...
                                <tbody>
                                    <?php if (empty($materials)): ?>
                                        <tr><td colspan="6" class="text-center">No material loan records found.</td></tr>
                                    <?php else: ?>
                                        <?php foreach ($materials as $row): ?>
                                            <tr>
                                                ...
                                                <td><?= $row->remarks ?></td>
                                                <td>
                                                    <a href="<?= base_url('MaterialLoan/delete/' . $row->id) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Delete this record?')">
...
<!-- Add Material Loan Modal -->
<div class="modal fade" id="addMaterialLoanModal" tabindex="-1">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <form method="post" action="<?= base_url('MaterialLoan/save') ?>" onsubmit="return validateMaterialLoan()">
                <div class="modal-header">
                    <h5 class="modal-title">Add Material Loan</h5>
